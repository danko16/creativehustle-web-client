    ...
    ut = (function () {
      ...
      return (
        ...
        (t._slide = function (t, e) {
          ...
          if (
            ((o = t === K ? ((n = J), (i = Z), B) : ((n = G), (i = tt), V)), l && g(l).hasClass(X))
          )
            this._isSliding = !1;
  ...
  var ft = 'collapse',
    ...
    wt = (function () {
      ...
      return (
        ...
        (t._getConfig = function (t) {
          return (
            ((t = l({}, mt, {}, t)).toggle = Boolean(t.toggle)), _.typeCheckConfig(ft, t, pt), t
          );
        }),
      ...
      return (
        ...
        (c._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (t || ((t = new c(this, 'object' == typeof e ? e : null)), g(this).data(Nt, t)),
              'string' == typeof e)
            ) {
        ...
        (c._clearMenus = function (t) {
          if (!t || (3 !== t.which && ('keyup' !== t.type || 9 === t.which)))
            for (
              var e = [].slice.call(document.querySelectorAll(Mt)), n = 0, i = e.length;
              n < i;
              n++
            ) {
        ...
        i = function (t) {
          ...
          i.forEach(function (t) {
            !(function (t, e) {
              ...
              if (-1 !== e.indexOf(n))
                return (
                  -1 === be.indexOf(n) || Boolean(t.nodeValue.match(De) || t.nodeValue.match(Ie))
                );
              for (
        ...
        (t._getOffset = function () {
          ...
          return (
            'function' == typeof this.config.offset
              ? (t.fn = function (t) {
                  return (
                    (t.offsets = l({}, t.offsets, {}, e.config.offset(t.offsets, e.element) || {})),
                    t
                  );
                })
