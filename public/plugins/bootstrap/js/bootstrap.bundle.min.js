    ...
    he = (function () {
      ...
      return (
        ...
        (e._getItemIndex = function (e) {
          return (
            (this._items =
              e && e.parentNode ? [].slice.call(e.parentNode.querySelectorAll(ie)) : []),
        ...
        (e._slide = function (e, t) {
          ...
          if (
            ((o = e === B ? ((n = $), (i = J), K) : ((n = G), (i = Z), Q)), l && p(l).hasClass(z))
          )
            this._isSliding = !1;
  ...
  var ue = 'collapse',
    ...
    De = (function () {
      function a(t, e) {
        ...
        for (
          var n = [].slice.call(document.querySelectorAll(Se)), i = 0, o = n.length;
          i < o;
          i++
        ) {
          var r = n[i],
      ...
      return (
            ...
            if ((p(this._element).trigger(i), !i.isDefaultPrevented())) {
              ...
              p(this._element).removeClass(ye).addClass(Ee),
                ...
                this._triggerArray.length &&
                  p(this._triggerArray).removeClass(be).attr('aria-expanded', !0),
        ...
        (e._getConfig = function (e) {
          return (
            ((e = l({}, me, {}, e)).toggle = Boolean(e.toggle)), m.typeCheckConfig(ue, e, ge), e
          );
        }),
            ...
            var c = i.priority,
              ...
              u = {
                primary: function (e) {
                  var t = h[e];
                  return (
                    h[e] < l[e] && !i.escapeWithReference && (t = Math.max(h[e], l[e])),
                    Ye({}, e, t)
                  );
                },
      ...
      return (
        ...
        (c._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              (e || ((e = new c(this, 'object' == typeof t ? t : null)), p(this).data(At, e)),
              'string' == typeof t)
            ) {
        ...
        (c._clearMenus = function (e) {
          if (!e || (3 !== e.which && ('keyup' !== e.type || 9 === e.which)))
            for (
              var t = [].slice.call(document.querySelectorAll(Ut)), n = 0, i = t.length;
              n < i;
              n++
            ) {
          ...
          if (
            (/input|textarea/i.test(e.target.tagName)
              ? !(
                  32 === e.which ||
                  (27 !== e.which &&
                    ((40 !== e.which && 38 !== e.which) || p(e.target).closest(qt).length))
                )
              : Lt.test(e.which)) &&
        ...
        i = function (e) {
          ...
          i.forEach(function (e) {
            !(function (e, t) {
              ...
              if (-1 !== t.indexOf(n))
                return (
                  -1 === Tn.indexOf(n) || Boolean(e.nodeValue.match(Sn) || e.nodeValue.match(Dn))
                );
              for (
        ...
        (e._getOffset = function () {
          ...
          return (
            'function' == typeof this.config.offset
              ? (e.fn = function (e) {
                  return (
                    (e.offsets = l({}, e.offsets, {}, t.config.offset(e.offsets, t.element) || {})),
                    e
                  );
                })
      ...
      return (
        ...
        (n._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              (e || ((e = new n(this, 'object' == typeof t && t)), p(this).data(ui, e)),
              'string' == typeof t)
            ) {
              if ('undefined' == typeof e[t]) throw new TypeError('No method named "' + t + '"');
              e[t]();
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            var e = p(this),
              t = e.data(zi);
            if (
              (t || ((t = new i(this, 'object' == typeof n && n)), e.data(zi, t)),
              'string' == typeof n)
            ) {
              if ('undefined' == typeof t[n]) throw new TypeError('No method named "' + n + '"');
              t[n](this);
